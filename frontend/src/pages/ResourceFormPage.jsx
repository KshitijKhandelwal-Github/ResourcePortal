        ...
        <form onSubmit={handleSubmit}>
          <div className="form-row">
            <div className="form-group">
              ...
              />
              {errors.employee_id && <span style={{ color: 'var(--danger)', fontSize: '12px', marginTop: '4px', display: 'block' }}>{errors.employee_id}</span>}
            </div>
            <div className="form-group">
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              {errors.cluster_id && <span style={{ color: 'var(--danger)', fontSize: '12px', marginTop: '4px', display: 'block' }}>{errors.cluster_id}</span>}
            </div>
            <div className="form-group">
          ...
          <div className="form-group">
            ...
            <select
              ...
              style={{ height: '130px', padding: '8px' }}
            >
              {skills.filter(s => String(s.id) !== String(form.primary_skill_id)).map(s => (
                <option key={s.id} value={s.id} style={{ padding: '4px 8px' }}>{s.name}</option>
              ))}
            </select>
          </div>
